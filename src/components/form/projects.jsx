function Project(props) {
    ...
    return (
        <section className="formSection">
            <form className="form">
                    <section className="formDoubleSection" id="projectSection">
                        ...
                        <div className="formSection">
                            ...
                            <textarea type="text" name="description" id="description" value={data.description} onChange={e => onChange(data.id, {...data, description: e.target.value})}/>
                        </div>
                        <div className="formSection">
